...
export const formText: ScoreText = {
  ...
  2: "not only did it not land on the plate, it's also sideways! 2 points!",
  3: "the butter should always be on top!\nat least it landed on the plate... that's 3 points.",
  4: 'that i had to witness such poor form...\n4 points, no comment.',
  ...
  8: "that's good form, but you could improve here and there. 8 points.",
  9: '9 points, you almost understand it!',
  10: 'splendid! the execution was full of finesse!\nmost deserving of these 10 points.',
};

export const lenientText: ScoreText = {
  0: "sorry, i can't stand wasting butter.\n0 points for that.",
  1: 'better luck next time! 1 point for encouragement.',
  3: 'nice trick landing, but next time try to be more precise. 3 points!',
  5: 'zzz... oops, missed that! 5 points, i guess?',
...
export const precisionText: ScoreText = {
  ...
  2: "landing the toast on the side is not the kind of precision i'm looking for. 2 points and that's it.",
  3: 'almost failing, yet not a complete failure.\namusing, 3 points.',
  4: "if this is the state of the magic academy these days, then we're doomed. 4 points.",
  ...
  9: "9 points. see, i'm not that hard to satisfy!",
